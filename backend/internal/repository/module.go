...
// DB returns the underlying *pg.DB connection.
// Domain modules (e.g., events) reuse this single connection rather than
// opening their own pool. Returns nil before Init.
func (m *Module) DB() *pg.DB {
	return m.db
}
